...
func setupStmtSummary() {
	...
	if instanceCfg.StatementsSummaryEnablePersistent {
		err := stmtsummaryv2.Setup(&stmtsummaryv2.Config{
			Filename:       instanceCfg.StatementsSummaryFilename,
			FileMaxSize:    instanceCfg.StatementsSummaryFileMaxSize,
			FileMaxDays:    instanceCfg.StatementsSummaryFileMaxDays,
			FileMaxBackups: instanceCfg.StatementsSummaryFileMaxBackups,
		})
		if err != nil {
