...
type SessionVars struct {
	...
	// EnablePersistentStatementsSummary indicates whether to enable the persistence
	// of statements summary in the current session.
	EnablePersistentStatementsSummary bool
	// StmtSummary refers to the global StmtSummary instance that will be used when
	// EnablePersistentStatementsSummary is true.
...
func NewSessionVars(hctx HookContext) *SessionVars {
	vars := &SessionVars{
		...
		EnablePersistentStatementsSummary: config.GetGlobalConfig().Instance.StatementsSummaryEnablePersistent,
